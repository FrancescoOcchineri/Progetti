          ...
          <div class="col-12 col-lg-10">
            <div class="card" style="border-radius: 1rem;">
              <div class="card-body p-5">
                ...
                <h1 class="mb-5 text-center">Add Courses</h1>
                ...
                <form method="post" action="/courses">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6 mb-4">
                      ...
                      <label class="form-label" for="form6Example2">Room</label>
                        <input name="room" type="number" id="form6Example2" class="form-control"  min="1" max="10" />
                      </div>
                    </div>
                  </div>
                  ...
                  <label class="form-label" for="form6Example3">Start Date</label>
                    <input name="start_date" type="date" id="form6Example3" class="form-control" />
                  </div>

                  <div class="form-outline mb-4">
                  <label class="form-label" for="form6Example4">End Date</label>
                    <input name="end_date" type="date" id="form6Example4" class="form-control" />                   
                  </div>
