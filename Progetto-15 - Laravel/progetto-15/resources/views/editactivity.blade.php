          ...
          <div class="col-12 col-lg-10">
            <div class="card" style="border-radius: 1rem;">
              ...
              <a href="javascript:void(0);" onclick="history.back();"><i class="fa-solid fa-arrow-left fs-4 text-dark"></i></a>
                <h1 class="mb-5 text-center">Edit Activity</h1>
                ...
                <form method="post" action="/activities/{{$activity->id}}">
                  ...
                  <div class="row">
                    <div class="col-12 col-md-6 mb-4">
                      ...
                      <label class="form-label" for="form6Example1">Name</label>
                        <input name="name" type="text" id="form6Example1" class="form-control" value="{{$activity->name}}" />
                      </div>
                    </div>
                    <div class="col-12 col-md-6 mb-4">
                      <div class="form-outline">
                      <label class="form-label" for="form6Example2">Time</label>
                        <input name="time" type="number" id="form6Example2" class="form-control"  min="1" max="4" value="{{$activity->time}}" />
                      </div>
                    </div>
                  </div>
                  ...
                  <label class="form-label" for="form6Example7">Description</label>
                    <textarea name="description" class="form-control" id="form6Example7" rows="4">{{$activity->description}}</textarea>   
                  </div>

                  <div class="form-outline mb-4">
                  <label class="form-label" for="form6Example7">Goal</label>
                    <textarea name="goal" class="form-control" id="form6Example7" rows="4">{{$activity->goal}}</textarea>   
                  </div>

                  <div class="form-outline mb-4">
                  <select name="day" class="form-select" id="exampleFormControlSelect1">
                    <option selected>{{$activity->day}}</option>
                  ...
                  <select name="difficulty" class="form-select" id="exampleFormControlSelect1">
                    <option selected>{{$activity->difficulty}}</option>
